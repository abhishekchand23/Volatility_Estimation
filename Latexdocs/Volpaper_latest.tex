...
\subsubsection{Meilijson estimator}
\begin{enumerate}
\item \textbf{The estimator}\\
Instead of taking just the quadratic terms and cross terms, we include the jump factor in the estimator. This is done to reproduce to Meilijson estimator with the jump factor.
$$\sigma^{2}= {a_{M}}^{u^2}*\frac{u^2}{1-f}+{a_{M}}^{d^2}*\frac{d^2}{1-f}+{a_{M}}^{c_{1}^2}*\frac{c_{1}^2}{1-f}$$ $$+ {a_{M}}^{ud}*\frac{ud}{1-f}+{a_{M}}^{uc_{1}}*\frac{uc_{1}}{1-f}+{a_{M}}^{dc_{1}}*\frac{dc_{1}}{1-f}$$ $$+ {a_{M}}^{c_{0}^2}*\frac{c_{0}^2}{f}$$
...
\item \textbf{Expectation of the second order moments:}\\
The expected values of the quadratic and cross terms will be independent of f.
$$ E(\frac{u^2}{1-f})=1.75\sigma^2\quad  E(\frac{d^2}{1-f} )=0.25\sigma^2\quad  E(\frac{c_{1}^2}{1-f} )=\sigma^2\quad $$ $$E(\frac{ud}{1-f})=(1-2\log 2)\sigma{^2} \quad E(\frac{uc}{1-f} )=1.25\sigma^2\quad E(\frac{dc_1}{1-f})=-0.25\sigma^2\quad E(\frac{c_{0}^2}{f})=\sigma^2 $$
...
$$=\begin{bmatrix}
5.8125\sigma^4&0.22741\sigma^4&3.875\sigma^4&-0.7159\sigma^4&
4.59375\sigma^4&-0.53376\sigma^4&1.75\sigma^4\\0.22741\sigma^4&0.1875\sigma^4&0.125\sigma^4&-0.1478\sigma^4&
0.15758\sigma^4&-0.09375\sigma^4&0.25\sigma^4\\3.875\sigma^4&0.125\sigma^4&3\sigma^4&-0.43808\sigma^4&
3.375\sigma^4&-0.375\sigma^4&\sigma^4\\-0.7159\sigma^4&-0.1478\sigma^4&-0.43808\sigma^4&0.22741\sigma^4&
-0.53376\sigma^4&0.15758\sigma^4&-0.38629\sigma^4\\4.59375\sigma^4&0.15758\sigma^4&3.375\sigma^4&-0.53376\sigma^4&
3.875\sigma^4&-0.43808\sigma^4&1.25\sigma^4\\-0.53376\sigma^4&-0.09375\sigma^4&-0.375\sigma^4&0.15758\sigma^4&
-0.43808\sigma^4&0.125\sigma^4&-0.25\sigma^4\\1.75\sigma^4&0.25\sigma^4&\sigma^4&-0.38629\sigma^4&
1.25\sigma^4&0.25\sigma^4&3\sigma^4
...
$$\vec{K}_{M}=
\begin{bmatrix}
1.75\sigma_1{^2} &\hdots &\sigma_1{^2}
&\hdots &1.25\sigma_1{^2}&\hdots &\sigma_1{^2}\\
1.75\sigma_2{^2} &\hdots &\sigma_2{^2} 
&\hdots &1.25\sigma_2{^2}&\hdots &\sigma_2{^2}\\
\vdots &\hdots &\vdots &\hdots &\vdots &\hdots\\
\vdots &\hdots &\vdots &\hdots &\vdots &\hdots
\end{bmatrix}$$
...
\end{bmatrix}
 $$
Meilijson:\quad $$\alpha_{M}: \alpha_1=-0.017077\quad \alpha_2=-0.018984\quad \alpha_3=-1.301307 \quad\\$$ $$
 \alpha_4=-0.324905\quad \alpha_5=0.651776 \quad \alpha_6=0.114649$$ 
 
 %MV SOLUTION
\item \textbf{Minimum Variance Solution:}\\
Putting values of alpha in the complete case above gives the following solution:\\
$${a_{M}}^{u^2}=0.48571\quad{a_{M}}^{d^2}=0.48292\quad{a_{M}}^{c_1^2}= -0.01898\quad{a_{M}}^{ud}=-1.30130$$
$$\quad{a_{M}}^{uc_1}=-0.32490\quad{a_{M}}^{dc_1}=0.65177\quad{a_{M}}^{c_0^2}=0.11464              $$

\item \textbf{Final Estimator}\\
$$\sigma^{2}= \frac{1}{1-f}(0.48571{u^2}+0.48292d^2-0.01898c_{1}^2-1.3013ud-0.01693uc_{1}0.6517dc_{1})+ 0.1146\frac{c_{0}^2}{f}$$
\begin{table}[ht]
\small
\caption{Variance and efficiency of Garman \& Klass and Meilijson Jump estimator}
\label{table:GK AND MJ JUMP}
\centering
\begin{tabular}{LS@{}SLSLS}
\midrule
\hline \\
\multicolumn{1}{@{\hspace{0.5em}}l}{} & \mc{Classical Estimator} & \mc{GK* Jump Estimator} && \mc{Meilijson Jump Estimator }   \\[1ex]
\midrule
Variance&1.97797&0.23633&&0.22716\\[1ex]
Efficiency&1&8.36946&&8.70735\\
\midrule\\[-2.5ex]
\multicolumn{3}{l}{*Garman \& Klass}\\
\end{tabular}
\end{table}

In Table 4 we show the variance and efficiency resulting from a simulated data\footnote{Where $\sigma^2=1.0$ and $f=0.3$ }. Meilijson estimator is observed to be a better class of estimator than Garman- Klass. Nonetheless, the efficiency of the estimators is seen to improve when new information is added.
\end{enumerate}
